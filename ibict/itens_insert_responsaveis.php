...
$collection = $collectionsRepo->fetch(['name'=>'Responsáveis'], 'OBJECT');
$collection = $collection[0];


$fh = fopen("portal_responsaveis.csv", "r") or die("ERROR OPENING DATA");
...
if (($handle = fopen("portal_responsaveis.csv", "r")) == TRUE) {
