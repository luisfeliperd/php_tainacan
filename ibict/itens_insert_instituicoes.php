...
$collection = $collectionsRepo->fetch(['name'=>'Instituições'], 'OBJECT');
$collection = $collection[0];


$fh = fopen("portal_instituicoes.csv", "r") or die("ERROR OPENING DATA");
...
if (($handle = fopen("portal_instituicoes.csv", "r")) == TRUE) {
